    ...
    <body>
        ...
        <div class="chatbot-modal" id="chatbot-modal">
            <div class="chatbot-content">
                <div class="chatbot-header">
                    ...
                    <button class="close-chatbot-button" id="closeChatbotButton">&times;</button>
                </div>
        ...
        <script>
            const AMALLAN_ASSETS = {
                mascot: "{{ asset('asset/maskot_amallan.png') }}",
                mascot_about: "{{ asset('asset/maskot_amallan_about.png') }}",
                temal: "{{ asset('asset/temal.png') }}",
                akmal: "{{ asset('asset/akmal.png') }}",
                aset1: "{{ asset('asset/aset1.png') }}",
                aset2: "{{ asset('asset/aset2.png') }}",
            };
        </script>
