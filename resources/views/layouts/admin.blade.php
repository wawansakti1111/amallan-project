...
<head>
    ...
    <style>
        ...
        /* Dropdown Profil - Hitam dengan Animasi */
        .profile-dropdown-content {
            ...
            margin-top: 0.5rem;
            width: 16rem;
            background-color: #111827; /* Hitam gelap */
            border-radius: 0.75rem;
            overflow: hidden;
    ...
    <!-- Untuk script tambahan di head (opsional) -->
    @stack('head-scripts')
</head>
<body class="font-sans antialiased bg-gray-100">
    ...
    <!-- Penting: Ini agar script preview gambar bisa dimuat -->
    @stack('scripts')
</body>
</html>